...
species_separate <- ggplot(species_counts, aes(x = survey_year, y = total_count)) +
  ...
  labs(title = "Distribution of Kelp Forest Species Abundance Used in Model Over Time",
       x = "Survey Year",
       y = "Total Count",
       caption = "Figure 1. This figure shows the abundance of species used in the model over time. The black dotted line sitting at the year 2013 indicates the first large marine heatwave during that time period. This heatwave significantly contributed to the alteration of the kelp forest ecosystem.") +
  theme_bw() +
